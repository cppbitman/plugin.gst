...
{
  gst_element_register (plugin, "cusmultifilesrc", GST_RANK_NONE,
      gst_multi_file_src_get_type ());
  gst_element_register (plugin, "cusmultifilesink", GST_RANK_NONE,
      gst_multi_file_sink_get_type ());
  gst_element_register (plugin, "cussplitfilesrc", GST_RANK_NONE,
